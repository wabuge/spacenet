...
<head>
    ...
    <title>IT Services | Spacenet Telecommunications LTD </title>
...
<body class="host_version">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbars-host">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="<?php echo $_SERVER['PHP_SELF']; ?>">I.T</a></li>
    ...
    <div class="all-title-box">
        <div class="container text-center">
            <h1>Small Enterprise Systems Design<span class="m_1">Spacenet Telecommunications has expertise in Developing softwares and Websites </span></h1>
        </div>
    </div>
