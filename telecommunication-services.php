    ...
    <div id="pricing" class="section lb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Get a Perfect Service </h3>
                <p><small>Our telcom solutions includes:</small></p>
            </div>
            <!-- end title -->
                    ...
                    <div class="pricingTable">
                        ...
                        <div class="pricingContent">
                            ...
                            <ul>
                                ...
                                <li>BTS Intergration</li>
                                <li>Site Commisioning</li>
                            </ul>
                        </div>
                        <!-- /  CONTENT BOX-->
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="pricingTable orange">
                        ...
                        <div class="pricingContent">
                            <i class="fa fa-cube"></i>
                            <ul>
                                <li>Fibre Network Design</li>
                                <li>Fiber Network Rollout</li>
                                <li>Civil Works</li>
                                <li>Splicing and Repares</li>
                                <li>FTTB & FTTH & FTTS</li>
                            </ul>
                        </div>
                        <!-- /  CONTENT BOX-->
    ...
    <div id="hosting" class="section wb" style="background: rgb(248, 248, 248)">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">We have worked round the clock to build our name by offering a trusted and reliable services to our clients<br> Have a look of the sample projects we have done since 2016</p>
            </div>
            <!-- end title -->
                    ...
                    <div class="widget server clearfix">
                        ...
                        <div class="inner-dit">
                            <div class="widget-title">
                                <h3>Malindi Tower</h3>
                                <small>Jan 2017- July 2017</small>
                            </div>
                            <!-- end title -->
                            <p>The Project included, acquiring the site, FTTS designing of the site, Construction , BTS intergration and finally commisioning</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                    <div class="widget server clearfix">
                        ...
                        <div class="inner-dit">
                            <div class="widget-title">
                                <h3>Mombasa Tower</h3>
                                <small>June 2018 to August 2018</small>
                            </div>
                            <!-- end title -->
                            <p>This complex project included maintenance of Mombasa- Changamwe Safaricom Tower</p>
                        </div>
